...
client.on('message', message => {
    if (message.content == "3عواصم") {
         message.react('🤔','👌')
        var x = [' اليمن', 'مصر', 'الجزائر', 'السعودية', 'العراق' , 'الامارات' , 'سوريا'
        ];
        var x2 = ['صنعاء', 'القاهرة', 'الجزائر', 'الرياض', 'بغداد', 'ابو ظبي','دمشق'
        ];
		var x3 = Math.floor(Math.random()*x.length)
        message.channel.send(`📢 امامك دقيقة لحل الاسئلة , السؤال يقول :  __**${x[x3]}**__ `).then(msg1=> {
            var r = message.channel.awaitMessages(msg => msg.content == x2[x3], {
...
client.on('message', message => {
    if (message.content == "3لغز") {
        ...
        var x2 = ['الاسفنج', 'الساعة', 'البحر', 'الهاتف', 'العمر', 'الشاي', 'سبعة اشخاص' ,'الهواء' ,'الف مليون'
        ];
		var x3 = Math.floor(Math.random()*x.length)
        message.channel.send(`📢 امامك دقيقة لحل الاسئلة , السؤال يقول :  __**${x[x3]}**__ `).then(msg1=> {
            var r = message.channel.awaitMessages(msg => msg.content == x2[x3], {
